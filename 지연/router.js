...
//리뷰작성라우터
// router.post("/review_write", function (request, response) {
...
//     let sql = "insert into review_info values(?, ?, ?, ?, ?, ?)";

//     conn.query(sql, [email, pw, tel, address], function (err, rows) {

//         if (rows) {
//             response.redirect("http://127.0.0.1:3000/식당메인");
//         } else {
//             console.log(err);
//         }
//     });
